...
Vanaf 1 januari 2008 fungeert TOP10NL als Basisregistratie Topografie (BRT). Daarmee is TOP10NL het standaard topografische basisbestand voor gebruik binnen de overheid op het betreffende schaalgebied. Voor meer informatie zie [www.rijksoverheid.nl](https://www.rijksoverheid.nl) en [www.kadaster.nl/BRT](https://www.kadaster.nl/zakelijk/registraties/basisregistraties/brt)
